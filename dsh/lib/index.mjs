...
*/const Config=z.object({dbPath:z.string().default("~/.dsh/atom-memory/memory.db"),pythonBin:z.string().default(""),autostart:z.boolean().default(true),enabled:z.boolean().default(true),extractionModel:z.object({provider:z.string().default(""),model:z.string().default(""),baseURL:z.string().default(""),protocol:z.string().default("openai"),apiKey:z.string().default("")}).default({provider:"",model:"",baseURL:"",protocol:"openai",apiKey:""}),captureEnabled:z.boolean().default(true),llmExtractionEnabled:z.boolean().default(true),extractionMaxTokens:z.number().default(2048),nudgeEnabled:z.boolean().default(true),nudgeIntervalMinutes:z.number().default(30),maxRecalledFacts:z.number().default(10),summaryTokens:z.number().default(1500),injectedSummaryTokens:z.number().default(800),contextInjectionEnabled:z.boolean().default(true),overviewEnabled:z.boolean().default(true),overviewIdleSeconds:z.number().default(90),overviewRefreshMinutes:z.number().default(15),rpcTimeoutMs:z.number().default(3e4),writeAckTimeoutMs:z.number().default(2500),maxVectorDistance:z.number().default(.7),minRelevance:z.number().default(0),maxActiveFacts:z.number().default(0),maxProfileRows:z.number().default(50),maxFactTokens:z.number().default(600),dedupMaxDistance:z.number().default(.1),multiValuedPredicates:z.array(z.string()).default([]),scopeEnabled:z.boolean().default(true),scopeOrg:z.string().default(""),scopeClient:z.string().default(""),scopeProject:z.string().default(""),scopeSeries:z.string().default(""),scopePhase:z.string().default("")});//#endregion
